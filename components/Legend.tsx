export default function Legend() {
  return (
    <div className="rounded-xl border border-slate-200 bg-white/90 p-4 shadow-sm">
      <h3 className="mb-3 font-semibold uppercase tracking-wide text-slate-600" style={{ fontSize: '2em' }}>Legend</h3>
      <ul className="space-y-2 text-slate-700" style={{ fontSize: '1.5em' }}>
